...
// Model step function
void controller1ModelClass::step(real_T &arg_x_e, real_T &arg_y_e, real_T
  &arg_z_e, real_T &arg_vx, real_T &arg_vy, real_T &arg_vz, real_T &arg_qx,
  real_T &arg_qy, real_T &arg_qz, real_T &arg_qw, real_T &arg_omegax, real_T
  &arg_omegay, real_T *arg_omegaz, real_T *arg_fx, real_T *arg_fy, real_T
  *arg_fz, real_T *arg_tau_x, real_T *arg_tau_y, real_T *arg_tau_z)
{
...
void controller1ModelClass::initialize()
{
  ...
  controller1_InitializeDataMapInfo((&rtM));
}
...
controller1ModelClass::RT_MODEL * controller1ModelClass::getRTM()
{
  return (&rtM);
}
