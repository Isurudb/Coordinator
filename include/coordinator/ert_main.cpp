...
static controller1ModelClass rtObj;    // Instance of model class
...
void rt_OneStep(void)
{
  ...
  // Step the model
  rtObj.step(arg_x_e, arg_y_e, arg_z_e, arg_vx, arg_vy, arg_vz, arg_qx, arg_qy,
             arg_qz, arg_qw, arg_omegax, arg_omegay, &arg_omegaz, &arg_fx,
             &arg_fy, &arg_fz, &arg_tau_x, &arg_tau_y, &arg_tau_z);
